...
2. Match enabled routes using the signed event's To recipients and optional sender-domain restrictions when provided. Unmatched events are skipped before fetching content.
